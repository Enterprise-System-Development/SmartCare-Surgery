...
<html>
  ...
  <div class="slidebar">
    ...
    <ul>
      ...
      <li><a href="#View doctors schedule">View doctors schedule</a></li>
      <li><a href="#View nurses schedule">View nurses schedule</a></li>
      <li><a href="#Calculate turnover">Calculate turnover</a></li>
      <li><a href="#Remove Patient">Remove Patient</a></li>
      <li><a href="#Change Price">Change Price</a></li>
  ...
  <div class="main">
    ...
    <div class="mainContent clearfix">
      ...
      <div id="View doctors schedule">
        <h2 class="header">View doctors schedule</h2>
      </div>
      <div id="View nurses schedule">
        <h2 class="header">View nurses schedule</h2>
      </div>
      <div id="Calculate turnover">
        <h2 class="header">Calculate turnover</h2>
      </div>
      <div id="Remove Patient">
        <h2 class="header">Remove Patient</h2>
      </div>
      <div id="Change Price">
        <h2 class="header">Change Price</h2>
      </div>
