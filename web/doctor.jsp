...
<html>
    <head>
        ...
        <link href="doctorStyle.css" rel="stylesheet" type="text/css"/>
    </head>
    <body>
        <div align ="center">
  ...
  <div class="slidebar">
    ...
    <ul>
      ...
      <li><a href="#Add Patients">Add Patients</a></li>
      <li><a href="#View Private Patients">View Private Patients</a></li>
      <li><a href="#View NHS Patients">View NHS Patients</a></li>
      <li><a href="#Issue a Prescription">Issue a Prescription</a></li>
      <li><a href="#Refer Patient">Refer Patient</a></li>
  ...
  <div class="main">
    ...
    <div class="mainContent clearfix">
      ...
      <div id="Add Patients">
        <h2 class="header">Add Patients</h2>
      </div>
      <div id="View Private Patients">
        <h2 class="header">View Private Patients</h2>
      </div>
      <div id="View NHS Patients">
        <h2 class="header">View NHS Patients</h2>
      </div>
      <div id="Issue a Prescription">
        <h2 class="header">Issue a Prescription</h2>
      </div>
      <div id="Refer Patient">
        <h2 class="header">Refer Patient</h2>
      </div>
